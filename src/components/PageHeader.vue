    ...
    <div class="container-fluid ms-bg-image text-white text-center fw-bold">
        ...
        <div class="ms-header-nav">
            <div class="ms-logo-container">
                ...
                <svg height="60px" width="60px" viewBox="0 0 1000 1000">
                ...
                <svg height="80px" width="80px" viewBox="0 0 1000 1000">
                    <path transform="scale(1,-1) translate(0,-650)" fill="#fff" stroke="" stroke-width="20" d="M224.1 307c63.6006 0 114.9 -51.2998 114.9 -114.9c0 -63.5996 -51.2998 -114.899 -114.9 -114.899c-63.5996 0 -114.899 51.2998 -114.899 114.899c0 63.6006 51.2998 114.9 114.899 114.9zM224.1 117.4c41.1006 0 74.7002 33.5 74.7002 74.6992
...
c32.6006 0 102.601 -2.7002 132.101 9c19.7002 7.89941 34.7998 23 42.5996 42.5996z" />
                ...
                <svg height="70px" width="70px" viewBox="0 0 1000 1000">
                    <path transform="scale(1,-1) translate(0,-650)" fill="transparent" stroke="#fff" stroke-width="50"
