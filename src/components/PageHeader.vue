...
<template>
    <div class="container-fluid ms-bg-image text-white text-center fw-bold">
        <!-- sponsors + navbar  -->
        <div class="ms-header-nav">
            <div class="ms-logo-container">
                ...
                <svg class="me-3" height="40px" width="40px" viewBox="-2.11 177 324.22 562">
                    <path transform="scale(1,-1) translate(0,-650)" fill="transparent" stroke="#fff" stroke-width="50"
                ...
                <svg class="me-4" height="40px" width="40px" viewBox="-0.07 233.83 448.25 448.15">
                ...
                <svg height="40px" width="40px" viewBox="-25 225.08 562 465.84">
                    <path transform="scale(1,-1) translate(0,-650)" fill="transparent" stroke="#fff" stroke-width="50"
            ...
            <nav class="text-uppercase">navbar links</nav>
        </div>
        <!-- hero -->
        <PageHero></PageHero>
    </div>
